...
function alterAdmin($args) {
    ...
    /* Input element for mobile background */

    $label = $doc->createElement("p");
    $label->setAttribute("class", "subTitle");
    $label->nodeValue = "Mobile background image";
    ...
    $input = $doc->createElement("select");
    $input->setAttribute("class", "form-control");
    $input->setAttribute("onchange", "fieldSaveParallax('mobileBackground',this.value,'pages');");
    $input->setAttribute("name", "mobileBackgroundSelect");
	...
	foreach($files as $file) {
		...
		if(isset($Wcms->get("pages", $Wcms->currentPage)->mobileBackground) && $Wcms->get("pages", $Wcms->currentPage)->mobileBackground == $file)
			$option->setAttribute("selected", "selected");
    ...
    /* Input element for logo */

    $label = $doc->createElement("p");
    $label->setAttribute("class", "subTitle");
    $label->nodeValue = "Logo image";
    ...
    $doc->getElementById("menu")->insertBefore($form_group, $doc->getElementById("menu")->lastChild);
